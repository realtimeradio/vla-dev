...
function pfb_cplx_2p_512c_16i_18o_core_config(this_block)
  ...
  this_block.setEntityName('pfb_cplx_2p_512c_16i_18o_core_ip_struct');
  ...
  pol_out0_port.setType('UFix_144_0');
  pol_out1_port = this_block.port('pol_out1');
  pol_out1_port.setType('UFix_144_0');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol_in0').width ~= 32*4);
      this_block.setError('Input data type for port "pol_in0" must have width=32*4.');
    end
    if (this_block.port('pol_in1').width ~= 32*4);
      this_block.setError('Input data type for port "pol_in1" must have width=32*4.');
    end
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('dsp/pfb_cplx_2p_512c_16i_18o_core_ip_struct.vhd');
