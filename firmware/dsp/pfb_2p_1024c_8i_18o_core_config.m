...
function pfb_2p_1024c_8i_18o_core_config(this_block)
  ...
  this_block.setEntityName('pfb_2p_1024c_8i_18o_core_ip_struct');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol_in0').width ~= 16*8);
      this_block.setError('Input data type for port "pol_in0" must have width=16*8.');
    end
    if (this_block.port('pol_in1').width ~= 16*8);
      this_block.setError('Input data type for port "pol_in1" must have width=16*8.');
    end
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('dsp/pfb_2p_1024c_8i_18o_core_ip_struct.vhd');
