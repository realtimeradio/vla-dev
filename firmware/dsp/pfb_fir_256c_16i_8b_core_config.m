...
function pfb_fir_256c_16i_8b_core_config(this_block)
  ...
  this_block.setEntityName('pfb_fir_256c_16i_8b_core_ip_struct');
  ...
  this_block.addFile('dsp/pfb_fir_256c_16i_8b_core_ip_struct.vhd');
return;
