...
--Date        : Tue May  3 12:49:39 2022
--Host        : rtr-dev1 running 64-bit Ubuntu 18.04.6 LTS
--Command     : generate_target pfb_cplx_2p_2048c_16i_18o_core_bd_wrapper.bd
--Design      : pfb_cplx_2p_2048c_16i_18o_core_bd_wrapper
...
entity pfb_cplx_2p_2048c_16i_18o_core_bd_wrapper is
  port (
    clk : in STD_LOGIC;
...
end pfb_cplx_2p_2048c_16i_18o_core_bd_wrapper;

architecture STRUCTURE of pfb_cplx_2p_2048c_16i_18o_core_bd_wrapper is
  component pfb_cplx_2p_2048c_16i_18o_core_bd is
  port (
    clk : in STD_LOGIC;
    overflow : out STD_LOGIC_VECTOR ( 0 to 0 );
    pol_in0 : in STD_LOGIC_VECTOR ( 255 downto 0 );
  ...
  end component pfb_cplx_2p_2048c_16i_18o_core_bd;
begin
pfb_cplx_2p_2048c_16i_18o_core_bd_i: component pfb_cplx_2p_2048c_16i_18o_core_bd
     port map (
      clk => clk,
