...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set Project {uram_2048x512_latency3_core}
	set ProjectFiles {
		...
		{{xpm_f79b36_vivado.mem}}
		{{uram_2048x512_latency3_core_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{uram_2048x512_latency3_core.vhd} -lib {xil_defaultlib}}
		{{uram_2048x512_latency3_core_clock.xdc}}
		{{uram_2048x512_latency3_core.xdc}}
	}
	set SimPeriod 1
	set SimTime 10
	...
	set TargetDir {/home/jackh/src/vla-dev/dsp/uram_2048x512_latency3_core}
	set TopLevelModule {uram_2048x512_latency3_core}
	set TopLevelSimulinkHandle 506479
	...
	dict set TopLevelPortInterface we DatFile {uram_2048x512_latency3_core_we.dat}
	...
	dict set TopLevelPortInterface we ClockDomain {uram_2048x512_latency3_core}
	...
	dict set TopLevelPortInterface data DatFile {uram_2048x512_latency3_core_data.dat}
	...
	dict set TopLevelPortInterface data ClockDomain {uram_2048x512_latency3_core}
	...
	dict set TopLevelPortInterface addr Type UFix_11_0
	dict set TopLevelPortInterface addr ArithmeticType xlUnsigned
	dict set TopLevelPortInterface addr BinaryPoint 0
	dict set TopLevelPortInterface addr Width 11
	dict set TopLevelPortInterface addr DatFile {uram_2048x512_latency3_core_addr.dat}
	...
	dict set TopLevelPortInterface addr ClockDomain {uram_2048x512_latency3_core}
	...
	dict set TopLevelPortInterface dout DatFile {uram_2048x512_latency3_core_dout.dat}
	...
	dict set TopLevelPortInterface dout ClockDomain {uram_2048x512_latency3_core}
	...
	dict set TopLevelPortInterface clk ClockDomain {uram_2048x512_latency3_core}
