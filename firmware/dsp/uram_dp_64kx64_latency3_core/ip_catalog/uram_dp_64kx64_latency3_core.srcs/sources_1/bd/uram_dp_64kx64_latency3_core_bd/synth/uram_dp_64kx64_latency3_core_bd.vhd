...
--Command     : generate_target uram_dp_64kx64_latency3_core_bd.bd
--Design      : uram_dp_64kx64_latency3_core_bd
...
entity uram_dp_64kx64_latency3_core_bd is
  port (
  ...
  attribute CORE_GENERATION_INFO of uram_dp_64kx64_latency3_core_bd : entity is "uram_dp_64kx64_latency3_core_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=uram_dp_64kx64_latency3_core_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=1,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SYSGEN,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of uram_dp_64kx64_latency3_core_bd : entity is "uram_dp_64kx64_latency3_core_bd.hwdef";
end uram_dp_64kx64_latency3_core_bd;

architecture STRUCTURE of uram_dp_64kx64_latency3_core_bd is
  component uram_dp_64kx64_latency3_core_bd_uram_dp_64kx64_latency3_core_1_0 is
  port (
    addra : in STD_LOGIC_VECTOR ( 15 downto 0 );
    addrb : in STD_LOGIC_VECTOR ( 15 downto 0 );
    dina : in STD_LOGIC_VECTOR ( 63 downto 0 );
  ...
  end component uram_dp_64kx64_latency3_core_bd_uram_dp_64kx64_latency3_core_1_0;
  signal addra_1 : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal addrb_1 : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal clk_1 : STD_LOGIC;
  signal dina_1 : STD_LOGIC_VECTOR ( 63 downto 0 );
  signal dinb_1 : STD_LOGIC_VECTOR ( 63 downto 0 );
  signal uram_dp_64kx64_latency3_core_1_douta : STD_LOGIC_VECTOR ( 63 downto 0 );
  signal uram_dp_64kx64_latency3_core_1_doutb : STD_LOGIC_VECTOR ( 63 downto 0 );
  signal wea_1 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal web_1 : STD_LOGIC_VECTOR ( 0 to 0 );
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 CLK.CLK CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN uram_dp_64kx64_latency3_core_bd_clk, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000";
...
begin
  ...
  addrb_1(15 downto 0) <= addrb(15 downto 0);
  clk_1 <= clk;
  dina_1(63 downto 0) <= dina(63 downto 0);
  dinb_1(63 downto 0) <= dinb(63 downto 0);
  douta(63 downto 0) <= uram_dp_64kx64_latency3_core_1_douta(63 downto 0);
  doutb(63 downto 0) <= uram_dp_64kx64_latency3_core_1_doutb(63 downto 0);
  wea_1(0) <= wea(0);
  web_1(0) <= web(0);
uram_dp_64kx64_latency3_core_1: component uram_dp_64kx64_latency3_core_bd_uram_dp_64kx64_latency3_core_1_0
     port map (
      addra(15 downto 0) => addra_1(15 downto 0),
      addrb(15 downto 0) => addrb_1(15 downto 0),
      clk => clk_1,
