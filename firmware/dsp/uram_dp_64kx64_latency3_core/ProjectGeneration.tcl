...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set Project {uram_dp_64kx64_latency3_core}
	set ProjectFiles {
		...
		{{xpm_3477ab_dpram.mem}}
		{{uram_dp_64kx64_latency3_core_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{uram_dp_64kx64_latency3_core.vhd} -lib {xil_defaultlib}}
		{{uram_dp_64kx64_latency3_core_clock.xdc}}
		{{uram_dp_64kx64_latency3_core.xdc}}
	}
	set SimPeriod 1
	set SimTime 10
	...
	set TargetDir {/home/jackh/src/vla-dev/dsp/uram_dp_64kx64_latency3_core}
	set TopLevelModule {uram_dp_64kx64_latency3_core}
	set TopLevelSimulinkHandle 123454
	...
	dict set TopLevelPortInterface web DatFile {uram_dp_64kx64_latency3_core_web.dat}
	...
	dict set TopLevelPortInterface web ClockDomain {uram_dp_64kx64_latency3_core}
	...
	dict set TopLevelPortInterface wea DatFile {uram_dp_64kx64_latency3_core_wea.dat}
	...
	dict set TopLevelPortInterface wea ClockDomain {uram_dp_64kx64_latency3_core}
	...
	dict set TopLevelPortInterface dinb DatFile {uram_dp_64kx64_latency3_core_dinb.dat}
	...
	dict set TopLevelPortInterface dinb ClockDomain {uram_dp_64kx64_latency3_core}
	...
	dict set TopLevelPortInterface dina DatFile {uram_dp_64kx64_latency3_core_dina.dat}
	...
	dict set TopLevelPortInterface dina ClockDomain {uram_dp_64kx64_latency3_core}
	...
	dict set TopLevelPortInterface addrb Type UFix_16_0
	dict set TopLevelPortInterface addrb ArithmeticType xlUnsigned
	dict set TopLevelPortInterface addrb BinaryPoint 0
	dict set TopLevelPortInterface addrb Width 16
	dict set TopLevelPortInterface addrb DatFile {uram_dp_64kx64_latency3_core_addrb.dat}
	...
	dict set TopLevelPortInterface addrb ClockDomain {uram_dp_64kx64_latency3_core}
	...
	dict set TopLevelPortInterface addra Type UFix_16_0
	dict set TopLevelPortInterface addra ArithmeticType xlUnsigned
	dict set TopLevelPortInterface addra BinaryPoint 0
	dict set TopLevelPortInterface addra Width 16
	dict set TopLevelPortInterface addra DatFile {uram_dp_64kx64_latency3_core_addra.dat}
	...
	dict set TopLevelPortInterface addra ClockDomain {uram_dp_64kx64_latency3_core}
	...
	dict set TopLevelPortInterface douta DatFile {uram_dp_64kx64_latency3_core_douta.dat}
	...
	dict set TopLevelPortInterface douta ClockDomain {uram_dp_64kx64_latency3_core}
	...
	dict set TopLevelPortInterface doutb DatFile {uram_dp_64kx64_latency3_core_doutb.dat}
	...
	dict set TopLevelPortInterface doutb ClockDomain {uram_dp_64kx64_latency3_core}
	...
	dict set TopLevelPortInterface clk ClockDomain {uram_dp_64kx64_latency3_core}
