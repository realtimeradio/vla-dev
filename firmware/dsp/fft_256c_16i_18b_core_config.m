...
function fft_256c_16i_18b_core_config(this_block)
  ...
  this_block.setEntityName('fft_256c_16i_18b_core_ip_struct');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol_in').width ~= 16*18);
      this_block.setError('Input data type for port "pol_in" must have width=18*32.');
    end
  ...
  this_block.addFile('dsp/fft_256c_16i_18b_core_ip_struct.vhd');
