...
function pfb_cplx_2p_2048c_16i_18o_core_config(this_block)

  % Revision History:
  %
  %   15-May-2012  (11:34 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /scratch/zaki/workspace/roachfengine/fft_2048ch_core.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('pfb_cplx_2p_2048c_16i_18o_core_ip_struct');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol_in0').width ~= 32*8);
      this_block.setError('Input data type for port "pol_in0" must have width=32*8.');
    end
    if (this_block.port('pol_in1').width ~= 32*8);
      this_block.setError('Input data type for port "pol_in1" must have width=32*8.');
    end
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('dsp/pfb_cplx_2p_2048c_16i_18o_core_ip_struct.vhd');
