...
function uram_dp_32kx64_latency3_core_config(this_block)


  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('uram_dp_32kx64_latency3_core_ip_struct');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('dsp/uram_dp_32kx64_latency3_core_ip_struct.vhd');
