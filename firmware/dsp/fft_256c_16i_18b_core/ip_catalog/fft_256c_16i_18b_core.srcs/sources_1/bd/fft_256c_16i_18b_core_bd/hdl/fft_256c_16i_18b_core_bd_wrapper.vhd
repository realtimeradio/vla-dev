...
--Command     : generate_target fft_256c_16i_18b_core_bd_wrapper.bd
--Design      : fft_256c_16i_18b_core_bd_wrapper
...
entity fft_256c_16i_18b_core_bd_wrapper is
  port (
    clk : in STD_LOGIC;
...
end fft_256c_16i_18b_core_bd_wrapper;

architecture STRUCTURE of fft_256c_16i_18b_core_bd_wrapper is
  component fft_256c_16i_18b_core_bd is
  port (
    clk : in STD_LOGIC;
    overflow : out STD_LOGIC_VECTOR ( 3 downto 0 );
    pol_in : in STD_LOGIC_VECTOR ( 287 downto 0 );
  ...
  end component fft_256c_16i_18b_core_bd;
begin
fft_256c_16i_18b_core_bd_i: component fft_256c_16i_18b_core_bd
     port map (
      clk => clk,
