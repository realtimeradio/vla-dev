...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set Project {pfb_cplx_2p_1024c_16i_18o_core}
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{pfb_cplx_2p_1024c_16i_18o_core_dist_mem_gen_i0_vivado.coe}}
		{{pfb_cplx_2p_1024c_16i_18o_core_dist_mem_gen_i1_vivado.coe}}
		{{pfb_cplx_2p_1024c_16i_18o_core_dist_mem_gen_i2_vivado.coe}}
		{{xpm_effb0c_vivado.mem}}
		{{xpm_98f453_vivado.mem}}
		{{xpm_912277_vivado.mem}}
		{{pfb_cplx_2p_1024c_16i_18o_core_dist_mem_gen_i3_vivado.coe}}
		{{pfb_cplx_2p_1024c_16i_18o_core_dist_mem_gen_i4_vivado.coe}}
		...
		{{pfb_cplx_2p_1024c_16i_18o_core_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{pfb_cplx_2p_1024c_16i_18o_core.vhd} -lib {xil_defaultlib}}
		{{pfb_cplx_2p_1024c_16i_18o_core_clock.xdc}}
		{{pfb_cplx_2p_1024c_16i_18o_core.xdc}}
	}
	set SimPeriod 1
	set SimTime 6144
	...
	set TargetDir {/home/jackh/src/vla-dev/dsp/pfb_cplx_2p_1024c_16i_18o_core}
	set TopLevelModule {pfb_cplx_2p_1024c_16i_18o_core}
	...
	dict set TopLevelPortInterface sync DatFile {pfb_cplx_2p_1024c_16i_18o_core_sync.dat}
	...
	dict set TopLevelPortInterface sync ClockDomain {pfb_cplx_2p_1024c_16i_18o_core}
	...
	dict set TopLevelPortInterface pol_in1 DatFile {pfb_cplx_2p_1024c_16i_18o_core_pol_in1.dat}
	...
	dict set TopLevelPortInterface pol_in1 ClockDomain {pfb_cplx_2p_1024c_16i_18o_core}
	...
	dict set TopLevelPortInterface pol_in0 DatFile {pfb_cplx_2p_1024c_16i_18o_core_pol_in0.dat}
	...
	dict set TopLevelPortInterface pol_in0 ClockDomain {pfb_cplx_2p_1024c_16i_18o_core}
	...
	dict set TopLevelPortInterface overflow DatFile {pfb_cplx_2p_1024c_16i_18o_core_overflow.dat}
	...
	dict set TopLevelPortInterface overflow ClockDomain {pfb_cplx_2p_1024c_16i_18o_core}
	...
	dict set TopLevelPortInterface pol_out0 DatFile {pfb_cplx_2p_1024c_16i_18o_core_pol_out0.dat}
	...
	dict set TopLevelPortInterface pol_out0 ClockDomain {pfb_cplx_2p_1024c_16i_18o_core}
	...
	dict set TopLevelPortInterface pol_out1 DatFile {pfb_cplx_2p_1024c_16i_18o_core_pol_out1.dat}
	...
	dict set TopLevelPortInterface pol_out1 ClockDomain {pfb_cplx_2p_1024c_16i_18o_core}
	...
	dict set TopLevelPortInterface sync_out DatFile {pfb_cplx_2p_1024c_16i_18o_core_sync_out.dat}
	...
	dict set TopLevelPortInterface sync_out ClockDomain {pfb_cplx_2p_1024c_16i_18o_core}
	...
	dict set TopLevelPortInterface clk ClockDomain {pfb_cplx_2p_1024c_16i_18o_core}
