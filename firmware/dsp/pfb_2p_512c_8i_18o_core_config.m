...
function pfb_2p_512c_8i_18o_core_config(this_block)
  ...
  this_block.setEntityName('pfb_2p_512c_8i_18o_core_ip_struct');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol_in1').width ~= 8*8);
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('dsp/pfb_2p_512c_8i_18o_core_ip_struct.vhd');
