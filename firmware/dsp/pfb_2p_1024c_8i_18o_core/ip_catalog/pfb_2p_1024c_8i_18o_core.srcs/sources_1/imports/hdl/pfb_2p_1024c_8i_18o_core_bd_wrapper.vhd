...
--Command     : generate_target pfb_2p_1024c_8i_18o_core_bd_wrapper.bd
--Design      : pfb_2p_1024c_8i_18o_core_bd_wrapper
...
entity pfb_2p_1024c_8i_18o_core_bd_wrapper is
  port (
    clk : in STD_LOGIC;
...
end pfb_2p_1024c_8i_18o_core_bd_wrapper;

architecture STRUCTURE of pfb_2p_1024c_8i_18o_core_bd_wrapper is
  component pfb_2p_1024c_8i_18o_core_bd is
  port (
    clk : in STD_LOGIC;
    overflow : out STD_LOGIC_VECTOR ( 0 to 0 );
    pol_in0 : in STD_LOGIC_VECTOR ( 127 downto 0 );
  ...
  end component pfb_2p_1024c_8i_18o_core_bd;
begin
pfb_2p_1024c_8i_18o_core_bd_i: component pfb_2p_1024c_8i_18o_core_bd
     port map (
      clk => clk,
