...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set Project {pfb_2p_512c_12i_18o_core}
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{pfb_2p_512c_12i_18o_core_dist_mem_gen_i0_vivado.coe}}
		{{pfb_2p_512c_12i_18o_core_dist_mem_gen_i1_vivado.coe}}
		{{pfb_2p_512c_12i_18o_core_dist_mem_gen_i2_vivado.coe}}
		{{pfb_2p_512c_12i_18o_core_dist_mem_gen_i3_vivado.coe}}
		{{pfb_2p_512c_12i_18o_core_dist_mem_gen_i4_vivado.coe}}
		{{pfb_2p_512c_12i_18o_core_dist_mem_gen_i5_vivado.coe}}
		...
		{{pfb_2p_512c_12i_18o_core_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{pfb_2p_512c_12i_18o_core.vhd} -lib {xil_defaultlib}}
		{{pfb_2p_512c_12i_18o_core_clock.xdc}}
		{{pfb_2p_512c_12i_18o_core.xdc}}
	}
	set SimPeriod 1
	set SimTime 6144
	...
	set TargetDir {/home/jackh/src/vla-dev/dsp/pfb_2p_512c_12i_18o_core}
	set TopLevelModule {pfb_2p_512c_12i_18o_core}
	set TopLevelSimulinkHandle 120618
	...
	dict set TopLevelPortInterface sync DatFile {pfb_2p_512c_12i_18o_core_sync.dat}
	...
	dict set TopLevelPortInterface sync ClockDomain {pfb_2p_512c_12i_18o_core}
	...
	dict set TopLevelPortInterface pol_in1 Type UFix_96_0
	dict set TopLevelPortInterface pol_in1 ArithmeticType xlUnsigned
	dict set TopLevelPortInterface pol_in1 BinaryPoint 0
	dict set TopLevelPortInterface pol_in1 Width 96
	dict set TopLevelPortInterface pol_in1 DatFile {pfb_2p_512c_12i_18o_core_pol_in1.dat}
	...
	dict set TopLevelPortInterface pol_in1 ClockDomain {pfb_2p_512c_12i_18o_core}
	...
	dict set TopLevelPortInterface pol_in0 Type UFix_96_0
	dict set TopLevelPortInterface pol_in0 ArithmeticType xlUnsigned
	dict set TopLevelPortInterface pol_in0 BinaryPoint 0
	dict set TopLevelPortInterface pol_in0 Width 96
	dict set TopLevelPortInterface pol_in0 DatFile {pfb_2p_512c_12i_18o_core_pol_in0.dat}
	...
	dict set TopLevelPortInterface pol_in0 ClockDomain {pfb_2p_512c_12i_18o_core}
	...
	dict set TopLevelPortInterface overflow DatFile {pfb_2p_512c_12i_18o_core_overflow.dat}
	...
	dict set TopLevelPortInterface overflow ClockDomain {pfb_2p_512c_12i_18o_core}
	...
	dict set TopLevelPortInterface pol_out0 DatFile {pfb_2p_512c_12i_18o_core_pol_out0.dat}
	...
	dict set TopLevelPortInterface pol_out0 ClockDomain {pfb_2p_512c_12i_18o_core}
	...
	dict set TopLevelPortInterface pol_out1 DatFile {pfb_2p_512c_12i_18o_core_pol_out1.dat}
	...
	dict set TopLevelPortInterface pol_out1 ClockDomain {pfb_2p_512c_12i_18o_core}
	...
	dict set TopLevelPortInterface sync_out DatFile {pfb_2p_512c_12i_18o_core_sync_out.dat}
	...
	dict set TopLevelPortInterface sync_out ClockDomain {pfb_2p_512c_12i_18o_core}
	...
	dict set TopLevelPortInterface clk ClockDomain {pfb_2p_512c_12i_18o_core}
