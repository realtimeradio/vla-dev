...
function pfb_fir_1024c_32i_core_config(this_block)
  ...
  this_block.setEntityName('pfb_fir_1024c_32i_core_ip_struct');
  ...
  pol_out_port.setType('UFix_576_0');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol_in').width ~= 3*32);
      this_block.setError('Input data type for port "pol_in" must have width=3*32.');
    end
  ...
  this_block.addFile('pfb_fir_1024c_32i_core_ip_struct.vhd');
return;
