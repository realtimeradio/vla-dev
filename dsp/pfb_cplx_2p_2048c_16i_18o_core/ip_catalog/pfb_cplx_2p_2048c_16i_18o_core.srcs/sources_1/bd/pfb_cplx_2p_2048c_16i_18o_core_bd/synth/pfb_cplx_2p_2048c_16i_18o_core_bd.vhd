...
--Date        : Mon May  2 11:26:42 2022
--Host        : rtr-dev1 running 64-bit Ubuntu 18.04.6 LTS
--Command     : generate_target pfb_cplx_2p_2048c_16i_18o_core_bd.bd
--Design      : pfb_cplx_2p_2048c_16i_18o_core_bd
...
entity pfb_cplx_2p_2048c_16i_18o_core_bd is
  port (
    clk : in STD_LOGIC;
  ...
  attribute CORE_GENERATION_INFO of pfb_cplx_2p_2048c_16i_18o_core_bd : entity is "pfb_cplx_2p_2048c_16i_18o_core_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=pfb_cplx_2p_2048c_16i_18o_core_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=1,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SYSGEN,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of pfb_cplx_2p_2048c_16i_18o_core_bd : entity is "pfb_cplx_2p_2048c_16i_18o_core_bd.hwdef";
end pfb_cplx_2p_2048c_16i_18o_core_bd;

architecture STRUCTURE of pfb_cplx_2p_2048c_16i_18o_core_bd is
  component pfb_cplx_2p_2048c_16i_18o_core_bd_pfb_cplx_2p_2048c_16i_18o_core_1_0 is
  port (
    pol_in0 : in STD_LOGIC_VECTOR ( 255 downto 0 );
    pol_in1 : in STD_LOGIC_VECTOR ( 255 downto 0 );
    sync : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component pfb_cplx_2p_2048c_16i_18o_core_bd_pfb_cplx_2p_2048c_16i_18o_core_1_0;
  signal clk_1 : STD_LOGIC;
  signal pfb_cplx_2p_2048c_16i_18o_core_1_overflow : STD_LOGIC_VECTOR ( 0 to 0 );
  signal pfb_cplx_2p_2048c_16i_18o_core_1_pol_out0 : STD_LOGIC_VECTOR ( 287 downto 0 );
  signal pfb_cplx_2p_2048c_16i_18o_core_1_pol_out1 : STD_LOGIC_VECTOR ( 287 downto 0 );
  signal pfb_cplx_2p_2048c_16i_18o_core_1_sync_out : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN pfb_cplx_2p_2048c_16i_18o_core_bd_clk, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000";
...
begin
  clk_1 <= clk;
  overflow(0) <= pfb_cplx_2p_2048c_16i_18o_core_1_overflow(0);
  pol_in0_1(255 downto 0) <= pol_in0(255 downto 0);
  pol_in1_1(255 downto 0) <= pol_in1(255 downto 0);
  pol_out0(287 downto 0) <= pfb_cplx_2p_2048c_16i_18o_core_1_pol_out0(287 downto 0);
  pol_out1(287 downto 0) <= pfb_cplx_2p_2048c_16i_18o_core_1_pol_out1(287 downto 0);
  sync_1(31 downto 0) <= sync(31 downto 0);
  sync_out(0) <= pfb_cplx_2p_2048c_16i_18o_core_1_sync_out(0);
pfb_cplx_2p_2048c_16i_18o_core_1: component pfb_cplx_2p_2048c_16i_18o_core_bd_pfb_cplx_2p_2048c_16i_18o_core_1_0
     port map (
      clk => clk_1,
      overflow(0) => pfb_cplx_2p_2048c_16i_18o_core_1_overflow(0),
