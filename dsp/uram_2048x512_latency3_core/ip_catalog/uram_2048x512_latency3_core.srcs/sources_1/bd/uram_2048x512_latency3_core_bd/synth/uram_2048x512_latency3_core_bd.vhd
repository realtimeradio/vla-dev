...
--Command     : generate_target uram_2048x512_latency3_core_bd.bd
--Design      : uram_2048x512_latency3_core_bd
...
entity uram_2048x512_latency3_core_bd is
  port (
  ...
  attribute CORE_GENERATION_INFO of uram_2048x512_latency3_core_bd : entity is "uram_2048x512_latency3_core_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=uram_2048x512_latency3_core_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=1,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SYSGEN,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of uram_2048x512_latency3_core_bd : entity is "uram_2048x512_latency3_core_bd.hwdef";
end uram_2048x512_latency3_core_bd;

architecture STRUCTURE of uram_2048x512_latency3_core_bd is
  component uram_2048x512_latency3_core_bd_uram_2048x512_latency3_core_1_0 is
  port (
    addr : in STD_LOGIC_VECTOR ( 10 downto 0 );
    data : in STD_LOGIC_VECTOR ( 511 downto 0 );
    we : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component uram_2048x512_latency3_core_bd_uram_2048x512_latency3_core_1_0;
  signal addr_1 : STD_LOGIC_VECTOR ( 10 downto 0 );
  signal clk_1 : STD_LOGIC;
  signal data_1 : STD_LOGIC_VECTOR ( 511 downto 0 );
  signal uram_2048x512_latency3_core_1_dout : STD_LOGIC_VECTOR ( 511 downto 0 );
  signal we_1 : STD_LOGIC_VECTOR ( 0 to 0 );
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 CLK.CLK CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN uram_2048x512_latency3_core_bd_clk, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000";
...
begin
  addr_1(10 downto 0) <= addr(10 downto 0);
  clk_1 <= clk;
  data_1(511 downto 0) <= data(511 downto 0);
  dout(511 downto 0) <= uram_2048x512_latency3_core_1_dout(511 downto 0);
  we_1(0) <= we(0);
uram_2048x512_latency3_core_1: component uram_2048x512_latency3_core_bd_uram_2048x512_latency3_core_1_0
     port map (
      addr(10 downto 0) => addr_1(10 downto 0),
      clk => clk_1,
